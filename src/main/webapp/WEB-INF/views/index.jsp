...
<form:form method="post" modelAttribute="apartments">
    <div class="flex-container">
        ...
        <span>Cena/Czynsz:<form:select path="price" type="number" min="1" max="200000000"/><form:errors path="price"
                                                                                                  cssClass="error"/></span><br>
        ...
        <span>Łazienki: <form:select path="bathrooms" type="number" min="0" max="10" value="1"/><form:errors
                path="rooms"
                cssClass="error"/></span><br>
        <span>Piętro: <form:select path="storey"/><form:errors path="storey" cssClass="error"/></span><br>
