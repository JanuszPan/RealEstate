...
insert into real_estate.apartments(area, bathrooms, description, image,
                                   lift, parking, rooms, storey, district_id)
                                   values (50,1,'Mieszkanie położone na Dąbiu, przy ul. Bajecznej',LOAD_FILE('baj1.jpg'),false,'brak',1,1,1);
